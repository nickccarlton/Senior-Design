...
Integrates our modular I/O panels;
Integrates our modular controls panels; and
Digitally processes input audio stream(s) to produce acoustically pleasing processed signal(s).
